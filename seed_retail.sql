...
--        -c "SELECT id, name, shop_type FROM shops WHERE shop_type = 'RETAIL';"
--
...
VALUES
  ('f2000000-0000-0000-0000-000000000001', :SHOP_ID, 'Beverages',      '#0369A1', 1),
  ('f2000000-0000-0000-0000-000000000002', :SHOP_ID, 'Snacks',         '#B45309', 2),
  ('f2000000-0000-0000-0000-000000000003', :SHOP_ID, 'Dairy & Eggs',   '#0D7A5F', 3),
  ('f2000000-0000-0000-0000-000000000004', :SHOP_ID, 'Instant Food',   '#6D28D9', 4),
  ('f2000000-0000-0000-0000-000000000005', :SHOP_ID, 'Personal Care',  '#BE185D', 5),
  ('f2000000-0000-0000-0000-000000000006', :SHOP_ID, 'Household',      '#065F46', 6)
...
VALUES
  -- Beverages
  ('a2000000-0000-0000-0000-000000000001', :SHOP_ID,
   'Coca-Cola',
   'Classic carbonated soft drink',
   'f2000000-0000-0000-0000-000000000001', TRUE),

  ('a2000000-0000-0000-0000-000000000002', :SHOP_ID,
   'Chang Beer',
   'Thai lager — cold and refreshing',
   'f2000000-0000-0000-0000-000000000001', TRUE),

  ('a2000000-0000-0000-0000-000000000003', :SHOP_ID,
   'Red Bull Thailand',
   'Original Thai energy drink in glass bottle',
   'f2000000-0000-0000-0000-000000000001', TRUE),

  ('a2000000-0000-0000-0000-000000000004', :SHOP_ID,
   'Lipton Iced Tea',
   'Ready-to-drink lemon iced tea',
   'f2000000-0000-0000-0000-000000000001', TRUE),

  ('a2000000-0000-0000-0000-000000000005', :SHOP_ID,
   'Mineral Water',
   'Still drinking water — Singha brand',
   'f2000000-0000-0000-0000-000000000001', TRUE),

  -- Snacks
  ('a2000000-0000-0000-0000-000000000006', :SHOP_ID,
   'Lay''s Potato Chips',
   'Crispy salted potato chips',
   'f2000000-0000-0000-0000-000000000002', TRUE),

  ('a2000000-0000-0000-0000-000000000007', :SHOP_ID,
   'Pocky',
   'Chocolate-coated biscuit sticks',
   'f2000000-0000-0000-0000-000000000002', TRUE),

  ('a2000000-0000-0000-0000-000000000008', :SHOP_ID,
   'Taro Fish Snack',
   'Sweet and spicy dried fish snack — Thai favourite',
   'f2000000-0000-0000-0000-000000000002', TRUE),

  -- Dairy & Eggs
  ('a2000000-0000-0000-0000-000000000009', :SHOP_ID,
   'Meiji Fresh Milk',
   'Full-cream fresh milk',
   'f2000000-0000-0000-0000-000000000003', TRUE),
  ...
  ('a2000000-0000-0000-0000-000000000012', :SHOP_ID,
   ...
   'f2000000-0000-0000-0000-000000000004', TRUE),
  ...
  ('a2000000-0000-0000-0000-000000000014', :SHOP_ID,
   ...
   'f2000000-0000-0000-0000-000000000005', TRUE),
  ...
  ('a2000000-0000-0000-0000-000000000016', :SHOP_ID,
   ...
   'f2000000-0000-0000-0000-000000000006', TRUE),
...
VALUES
  ...
  ('b2000000-0000-0000-0000-000000000001', 'a2000000-0000-0000-0000-000000000001',
   'Can 325ml',  'COKE-CAN-325',  '5000112637922',  20.00,  12.00, TRUE, 48, TRUE),
  ('b2000000-0000-0000-0000-000000000002', 'a2000000-0000-0000-0000-000000000001',
   'Bottle 600ml','COKE-BTL-600', '5000112638523',  28.00,  18.00, TRUE, 36, TRUE),
  ('b2000000-0000-0000-0000-000000000003', 'a2000000-0000-0000-0000-000000000001',
   'Bottle 1.25L','COKE-BTL-125', '5000112639124',  45.00,  30.00, TRUE, 24, TRUE),

  -- Chang Beer
  ('b2000000-0000-0000-0000-000000000004', 'a2000000-0000-0000-0000-000000000002',
   'Can 320ml',   'CHANG-CAN-320', '8850987001234',  45.00,  30.00, TRUE, 60, TRUE),
  ('b2000000-0000-0000-0000-000000000005', 'a2000000-0000-0000-0000-000000000002',
   'Bottle 630ml','CHANG-BTL-630', '8850987001241',  65.00,  42.00, TRUE, 48, TRUE),

  -- Red Bull Thailand
  ('b2000000-0000-0000-0000-000000000006', 'a2000000-0000-0000-0000-000000000003',
   'Glass Bottle 150ml','REDBULL-TH-150','8851123000012',  15.00,  8.00, TRUE, 120, TRUE),

  -- Lipton Iced Tea
  ('b2000000-0000-0000-0000-000000000007', 'a2000000-0000-0000-0000-000000000004',
   'Bottle 500ml','LIPTON-500',    '8990000101502',  25.00,  16.00, TRUE, 36, TRUE),

  -- Mineral Water
  ('b2000000-0000-0000-0000-000000000008', 'a2000000-0000-0000-0000-000000000005',
   'Bottle 600ml','WATER-600',     '8850006000602',  10.00,   5.00, TRUE, 100, TRUE),
  ('b2000000-0000-0000-0000-000000000009', 'a2000000-0000-0000-0000-000000000005',
   'Bottle 1.5L', 'WATER-1500',    '8850006001502',  18.00,  10.00, TRUE, 60, TRUE),

  -- Lay's Potato Chips
  ('b2000000-0000-0000-0000-000000000010', 'a2000000-0000-0000-0000-000000000006',
   'Small 28g',   'LAYS-SM-28',    '8850014101284',  15.00,   9.00, TRUE, 80, TRUE),
  ('b2000000-0000-0000-0000-000000000011', 'a2000000-0000-0000-0000-000000000006',
   'Regular 50g', 'LAYS-REG-50',   'B850014101501',  25.00,  15.00, TRUE, 60, TRUE),
  ('b2000000-0000-0000-0000-000000000012', 'a2000000-0000-0000-0000-000000000006',
   'Large 75g',   'LAYS-LG-75',    '8850014101757',  35.00,  22.00, TRUE, 40, TRUE),

  -- Pocky
  ('b2000000-0000-0000-0000-000000000013', 'a2000000-0000-0000-0000-000000000007',
   'Chocolate 47g','POCKY-CHOC-47','4903333114566',  35.00,  22.00, TRUE, 50, TRUE),
  ('b2000000-0000-0000-0000-000000000014', 'a2000000-0000-0000-0000-000000000007',
   'Strawberry 47g','POCKY-STR-47','4903333114573',  35.00,  22.00, TRUE, 50, TRUE),

  -- Taro Fish Snack
  ('b2000000-0000-0000-0000-000000000015', 'a2000000-0000-0000-0000-000000000008',
   'Original 52g','TARO-ORIG-52',  '8850006220521',  20.00,  12.00, TRUE, 70, TRUE),
  ('b2000000-0000-0000-0000-000000000016', 'a2000000-0000-0000-0000-000000000008',
   'Spicy 52g',   'TARO-SPCY-52',  '8850006220538',  20.00,  12.00, TRUE, 70, TRUE),

  -- Meiji Milk
  ('b2000000-0000-0000-0000-000000000017', 'a2000000-0000-0000-0000-000000000009',
   'Carton 225ml','MEIJI-225',     '4902888232107',  18.00,  12.00, TRUE, 30, TRUE),
  ('b2000000-0000-0000-0000-000000000018', 'a2000000-0000-0000-0000-000000000009',
   'Carton 1L',   'MEIJI-1L',      '4902888232114',  65.00,  45.00, TRUE, 20, TRUE),

  -- Dutch Mill Yoghurt
  ('b2000000-0000-0000-0000-000000000019', 'a2000000-0000-0000-0000-000000000010',
   'Mixed Berry 180ml','DUTCHMIL-MB', '8851876000190', 15.00, 9.00, TRUE, 40, TRUE),
  ('b2000000-0000-0000-0000-000000000020', 'a2000000-0000-0000-0000-000000000010',
   'Original 180ml',  'DUTCHMIL-OR', '8851876000183', 15.00, 9.00, TRUE, 40, TRUE),
  ...
  ('b2000000-0000-0000-0000-000000000023', 'a2000000-0000-0000-0000-000000000012',
   'Tom Yum 55g', 'MAMA-TY-55',    '8850714100559',   6.00,   3.50, TRUE, 150, TRUE),
  ('b2000000-0000-0000-0000-000000000024', 'a2000000-0000-0000-0000-000000000012',
   'Pork 55g',    'MAMA-PK-55',    '8850714100566',   6.00,   3.50, TRUE, 150, TRUE),
  ('b2000000-0000-0000-0000-000000000025', 'a2000000-0000-0000-0000-000000000012',
   'Shrimp 55g',  'MAMA-SH-55',    '8850714100573',   6.00,   3.50, TRUE, 100, TRUE),
  ...
  ('b2000000-0000-0000-0000-000000000028', 'a2000000-0000-0000-0000-000000000014',
   'Tube 35g',    'COLGATE-35',    '8710908937636',  35.00,  22.00, TRUE, 30, TRUE),
  ('b2000000-0000-0000-0000-000000000029', 'a2000000-0000-0000-0000-000000000014',
   'Tube 150g',   'COLGATE-150',   '8710908937643',  89.00,  58.00, TRUE, 20, TRUE),

  -- Panadol
  ('b2000000-0000-0000-0000-000000000030', 'a2000000-0000-0000-0000-000000000015',
   '10 Tablets',  'PANADOL-10',    '3838900005455',  30.00,  18.00, TRUE, 50, TRUE),
  ('b2000000-0000-0000-0000-000000000031', 'a2000000-0000-0000-0000-000000000015',
   '24 Tablets',  'PANADOL-24',    '3838900005462',  65.00,  40.00, TRUE, 30, TRUE),

  -- Dish Soap
  ('b2000000-0000-0000-0000-000000000032', 'a2000000-0000-0000-0000-000000000016',
   'Bottle 500ml','SOAP-500',      '8850006030501',  45.00,  28.00, TRUE, 25, TRUE),
